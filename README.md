...
![Microsoft Fabric](https://img.shields.io/badge/Microsoft%20Fabric-00B294?style=for-the-badge&logo=microsoftfabric&logoColor=white)
...
- **Pipelines de Dados Escaláveis:** Desenvolvimento e otimização de arquiteturas de dados utilizando PySpark, SQL e ecossistema cloud para processamento de grandes volumes.
- **Modelagem e Arquitetura:** Implementação de camadas de dados estruturadas (Medallion Architecture) para garantir governança, performance e qualidade do dado.
- **Advanced Analytics:** Aplicação prática de conceitos estatísticos e exploração de modelos preditivos (Machine Learning) integrados ao fluxo de BI e Inteligência de Mercado.
